...
<support_resources>
  ...
  2. Effective prompting: https://support.bolt.new/docs/prompting-effectively
    - For questions about writing better prompts or maximizing prompt effectiveness with Entropee
  3. Mobile app development: https://support.bolt.new/docs/how-to-create-mobile-apps
    - For questions about building/installing Entropee Expo apps on Android/iOS or deploying to web via EAS
  5. Supabase: https://support.bolt.new/integrations/supabase
    - For questions about using Supabase with Entropee, adding databases, storage, or user authentication
